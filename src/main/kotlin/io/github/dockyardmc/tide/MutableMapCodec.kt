...
class MutableMapCodec<K, V>(private val keyCodec: Codec<K>, private val valueCodec: Codec<V>) : Codec<MutableMap<K, V>> {

    override fun writeNetwork(buffer: ByteBuf, value: MutableMap<K, V>) {
    ...
    override fun readNetwork(buffer: ByteBuf): MutableMap<K, V> {
    ...
    override fun readJson(json: JsonElement, field: String): MutableMap<K, V> {
